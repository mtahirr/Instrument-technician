...
class installedBellowHpTapping_view extends StatelessWidget {
  const installedBellowHpTapping_view({super.key});

  @override
  Widget build(BuildContext context) {
    installedBellowHpTapping_controller dataController =
        Provider.of<installedBellowHpTapping_controller>(context);
    return Scaffold(
      appBar: GlobalAppBar(
              ...
              Row(
                children: [
                  ...
                  Expanded(
                    child: buildTextField(
                        'S.G L2',
                        dataController.entered_Sghaed2,
                        (value) => dataController.processresults()),
                  ),
                ],
              ),
                  ...
                  Container(
                    ...
                    decoration: const BoxDecoration(
                        image: DecorationImage(
                            image: AssetImage("assets/1_3.png"))),
                  ),
                ],
              )
            ],
